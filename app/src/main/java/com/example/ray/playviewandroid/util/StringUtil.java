...
public class StringUtil {
    ...
    public static boolean isNumberOrAlpha(String s) {
        if (s == null) {
            LogUtil.d(TAG, "isNumberOrAlpha  s == null >> return false;");
            return false;
        }
    ...
    public static boolean isIDCard(String idCard) {
        ...
        idCard = get(idCard);
        if (idCard.length() == 15) {
            LogUtil.w(TAG, "isIDCard idCard.length() == 15 old IDCard");
...
//		}
    ...
    public static String getPrice(String price, int formatType) {
        ...
        LogUtil.i(TAG, "getPrice  <<<<<<<<<<<<<<<<<< correctPrice =  " + correctPrice);
...
//			}
    ...
    public static boolean isValidUrl(String url) {
        ...
        if(pattern.matcher(validUrl).matches()) {
            return true;
        }
        return false;*/
        return isValidUrlFromOther(url);
    }
    ...
    public static boolean isValidUrlFromOther(String url) {
        // wei.yw.ye 20181204 modify to valid http url
